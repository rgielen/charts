...
- [Downstream automerges minor bumps](downstream-automerges-minor-bumps.md) — k3s-nuc merges non-major chart bumps unattended; only a major bump still buys a human decision
