...
- [Downstream automerge needs ignoreTests](downstream-automerges-minor-bumps.md) — a repo with no checks reports status `pending` forever, so Renovate never automerges; measured, fix open as k3s-nuc#105
